...
@Autonomous(name = "RedBackAuton", group = "Testing")
public class RedBackAuton extends LinearOpMode
{
    ...
    {
        encoderDrive(inches, inches, inches, inches, 10, DRIVE_SPEED);
    }
    ...
    {
        Orientation _angles = getAngles();
        float target = _angles.firstAngle + degrees;
    ...
    public void rightSideways(int inches)
    {
        encoderDrive(inches, -inches, -inches, inches, 10, DRIVE_SPEED);
    }
