...
@Autonomous(name = "encoderdrivelattest", group = "Force of Oros")
public class encoderdrivelattest extends LinearOpMode
{
    ...
    public void runOpMode() {
        ...
        for(int i = 1; i <= 5; i++)
        {
            encoderDrive(0, 0, x*i, 5, .7);
            telemetry.addData("Hi:", i);
            telemetry.addData("Counts", robot.center.getCurrentPosition());
            telemetry.update();
            sleep(1000);
