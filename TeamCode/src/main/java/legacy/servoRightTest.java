...
@Autonomous(name = "ServoRightTest", group = "Force of Oros")
public class servoRightTest extends LinearOpMode
{
    ...
    public void runOpMode() {
        ...
        {
            x = x + .1*i;
            robot.vaServoRightT.setPosition(x);
            telemetry.addData("posRT", robot.vaServoRightT.getPosition());
            telemetry.update();
            x = 0;
            sleep(1000);
        ...
        {
            x = x + .1*i;
            robot.vaServoRightB.setPosition(x);
            telemetry.addData("posRT", robot.vaServoRightB.getPosition());
            telemetry.update();
            x = 0;
            sleep(1000);
