...
@Autonomous(name = "FoOAutoBlueFarRev", group = "Force of Oros")
public class FoOAutoBlueFarRev extends LinearOpMode
{
    /* Declare OpMode members. */
    FoOHardwareREV robot   = new FoOHardwareREV();   // Use a Pushbot's hardware
    private ElapsedTime runtime = new ElapsedTime();

    static final double     COUNTS_PER_MOTOR_REV    = 1120 ;    // eg: Rev Core Hex Encoder
    ...
    public void runOpMode() {
        ...
        encoderDrive(1,1, 0 ,5,DRIVE_SPEED);
        ...
        */
        ...
        if(glypos == "LEFT")
        {
            encoderDrive(.5, .5,0, 5, DRIVE_SPEED);
            encoderDrive(0,0,.75,5, DRIVE_SPEED);
            //turnDegrees(-8, TURN_SPEED, 5);
            encoderDrive(2.25,2.25,0,5, DRIVE_SPEED);
        }
        else if(glypos == "CENTER")
        {
            encoderDrive(.5, .5,0, 10, DRIVE_SPEED);
            encoderDrive(0,0,.5,10, DRIVE_SPEED);
            turnDegrees(-23, TURN_SPEED, 5);
            encoderDrive(2.7,2.7,0,5, DRIVE_SPEED);

        }
        else if(glypos == "RIGHT")
        {
            encoderDrive(.5, .3,0, 10, DRIVE_SPEED);
            encoderDrive(0,0,1,10, DRIVE_SPEED);
            turnDegrees(-37, TURN_SPEED, 5);
            encoderDrive(4.1,4.1,0,5, DRIVE_SPEED);
        ...
        */
        ...
        sleep(100);
        encoderDrive(-2.0,-2.0, 0,5, DRIVE_SPEED);
