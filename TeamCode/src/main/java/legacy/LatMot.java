...
@Disabled
@Autonomous(name = "LatMot", group = "Force of Oros")
public class LatMot extends LinearOpMode
{
    ...
    public void runOpMode() {
        ...
        */
        ...
        telemetry.addData("Position center",  robot.center.getCurrentPosition());
        telemetry.addData("Center data added", "hi" );
        telemetry.update();
        sleep(2000);

        */

        encoderDrive(0, 0, 10, 5, DRIVE_SPEED);
