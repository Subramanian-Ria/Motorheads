 ...
 */
@Disabled
@Autonomous(name = "FoOAutoBlueClose", group = "Force of Oros")
public class FoOAutoBlueClose extends LinearOpMode
{
    ...
    public void runOpMode() {
        ...
        */
        ...
        if(glypos == "RIGHT")
        {
            encoderDrive(1.10, 1.10, 5, DRIVE_SPEED);
            turnDegrees(75, TURN_SPEED,5);
            encoderDrive(3.25,3.25,5, DRIVE_SPEED);
        }
        else if(glypos == "CENTER")
        {
            encoderDrive(2.5, 2.5, 10, DRIVE_SPEED);
            turnDegrees(68, TURN_SPEED,5);
            encoderDrive(3,3,5, DRIVE_SPEED);

        }
        else if(glypos == "LEFT")
        {
            encoderDrive(4.75, 4.75, 10, DRIVE_SPEED);
            turnDegrees(68, TURN_SPEED,5);
            encoderDrive(2.5,2.5,5, DRIVE_SPEED);
