...
@Autonomous(name = "FoORedJewelHit", group = "Force of Oros")
@Disabled
public class FoORedJewelHit extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        if (blueValue > redValue) // if blue then rotate backwards to hit blue
        {
            ...
            sleep(500);
        } else if (redValue > blueValue) // if red then rotate forwards to hit blue
        {
            /**
